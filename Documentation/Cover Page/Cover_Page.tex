...
{\LARGE Absolute and Relative Pointing \\ using \\[0.3\baselineskip] Leap Motion}\\[0.2\baselineskip] % Title

\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt} % Thin horizontal line
\rule{\textwidth}{1.6pt}\\[\baselineskip] % Thick horizontal line

\scshape % Small caps
Abstract will go here. \\ % Tagline(s) or further description
...
{\Large Payel \\ Afaque  \\ Chris  \\ Farbod \\Maninder \par} % Editor list
