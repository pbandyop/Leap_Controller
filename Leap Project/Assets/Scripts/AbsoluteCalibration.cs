...
public class AbsoluteCalibration : MonoBehaviour {
	...
	public GUIText guiTextScreenCoords;
...
//		guiTextRaw.text = "Raw data: X: " + Round(vScreenIntersect.x, 2) + " Y: " + Round(vScreenIntersect.y,2) + " Z: " + Round(vScreenIntersect.z, 2);	
	...
	void LeapToScreen(){
////TEMP///////////
		//Convert Intersect (normalised) to screen position using screen dimensions
		vScreenCoords.x = vScreenIntersect.x * screenWidth;
		vScreenCoords.y = screenHeight - (vScreenIntersect.y * screenHeight);			//Invert for screen coordinates
		vScreenCoords.z = 0;
...
//		vScreenCoords = Vector3.Scale(vTransposedFingerUnity, vScale);	
	...
	void UpdateGuiText(){
		guiTextRaw.text = "Raw data: X: " + Round(vScreenIntersect.x, 2) + " Y: " + Round(vScreenIntersect.y,2) + " Z: " + Round(vScreenIntersect.z, 2);
		guiTextScreenCoords.text = "Leap coords: X " + Round(vScreenCoords.x, 2) + "   Y " + Round(vScreenCoords.y, 2);
