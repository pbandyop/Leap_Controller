/*
 *  Filename    : Circles.cs
 *  Description : Draws circles and targets. Handles hit tests between graphical objects. Records states of circles.
 *				  Controls Timer. REQUIRES Pointer and Timer. ADD TO CAMERA.
 *
...
public class Circles : MonoBehaviour {
	...
	Vector2 vRedPos, vYellowPos, vBluePos, vGreenPos;							// Current positions of circles
																				// updated by UpdateGUI
	...
	int circleGrabbed = 0;										// 0=NONE; 1=red; 2=yellow; 3=blue; 4=green
																//Records which circle currently grabbed

	int completedCount = 0;										//Tracks number of completed circle drops

	int hitRadius;												//Distance from centre of target for circle position
																//to be a hit.
	...
	public void UpdateGUI(){
		...
		//Execute logic based on which circle grabbed. 0=NONE; 1=red; 2=yellow; 3=blue; 4=green.
		switch (circleGrabbed) {

			// No circle grabbed. IF pointer is grabbed for the 1st time, initiate hittests.
			case 0:
